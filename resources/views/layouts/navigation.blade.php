            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.rates.index')" :active="request()->routeIs('admin.rates.*')">
                            Tarif
                        </x-nav-link>
                    ...
                    @elseif (Auth::user()->isCustomer())
                        <x-nav-link :href="route('customer.shipments.create')" :active="request()->routeIs('customer.shipments.create')">
                            Buat Shipment
                        </x-nav-link>
                    ...
                    @elseif (Auth::user()->isCourier())
                        <x-nav-link :href="route('courier.shipments.index')" :active="request()->routeIs('courier.shipments.*') || request()->routeIs('courier.trackings.*')">
                            Tugas Kurir
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.rates.index')" :active="request()->routeIs('admin.rates.*')">
                    Tarif
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.customers.index')" :active="request()->routeIs('admin.customers.*')">
                    Customer
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.shipments.index')" :active="request()->routeIs('admin.shipments.*')">
                    Shipment
                </x-responsive-nav-link>
            ...
            @elseif (Auth::user()->isCustomer())
                <x-responsive-nav-link :href="route('customer.shipments.create')" :active="request()->routeIs('customer.shipments.create')">
                    Buat Shipment
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('customer.shipments.index')" :active="request()->routeIs('customer.shipments.*')">
                    Shipment Saya
                </x-responsive-nav-link>
            ...
            @elseif (Auth::user()->isCourier())
                <x-responsive-nav-link :href="route('courier.shipments.index')" :active="request()->routeIs('courier.shipments.*') || request()->routeIs('courier.trackings.*')">
                    Tugas Kurir
                </x-responsive-nav-link>
            @endif
        </div>
